...
class _Started implements AlarmEvent {
  const _Started();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AlarmState);
}
...
/// @nodoc
class $AlarmStateCopyWith<$Res>  {
$AlarmStateCopyWith(AlarmState _, $Res Function(AlarmState) __);
}
...
class _Initial implements AlarmState {
  const _Initial();
